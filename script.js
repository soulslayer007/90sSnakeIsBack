...
//This function is used to initialized variables.
function initialize() {
  var he = document.getElementById("height");
	var wi = document.getElementById("width");
	document.getElementById("he").innerText = he.value;
	document.getElementById("wi").innerText = wi.value;
  // To always keep the resizable gamearea under the max value or inside the window.
  document.getElementById("height").max = window.outerHeight-300;
  document.getElementById("width").max = window.outerWidth-200;
  ...
  gameAreaWidth = wi.value;
  gameAreaHeight = he.value;
  cellWidth = 20;
 ...
 //This function is used to define the Playing space on changing the window size.
 function playSpace(){
  gameAreaWidth = wi.value;
  gameAreaHeight = he.value;
  var w = window.outerWidth;
  var h = window.outerHeight
  document.getElementById("height").max = h-300;
  document.getElementById("width").max = w-200;
  initialize();
...
//This function is used to create food at random spaces
function createFood() {
  snakeFood = {
...
function createGameArea() {
  ...
  // TO control how the snake body grows. 
...
// To imply that the snake dosen't overlap or "EAT ITSELF"
